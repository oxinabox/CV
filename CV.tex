...
\usepackage[scale=.7,top=2cm, bottom=1cm]{geometry}
...
\cventry{2015 March-- 2018 Oct}{PhD (NLP/ML)}{The University of Western Australia}{}{}{Thesis: ``On the surprising capacity of linear combinations of embeddings for natural language processing''. (Machine learning for natural language processing)}
\cventry{2014 Nov -- 2018 Oct}{Research and Teaching Assistant}{The University of Western Australia}{Perth, Australia}{(Casual)}{}
\cventry{2011 July -- 2012 March}{Agile Platforms Developer}{Bankwest}{Perth, Australia}{Australian Computing Society Workplace Integrated Learning Scholarship}{}
\cventry{2009--2014}{Bachelor of Engineering, with Honours}{The University of Western Australia}{}{}{(Major in Electrical and Electronic Engineering)}
...
\section{Awards}
\cvitem{2022 Julia Community Prize}{Quote ``For her many technical and community contributions across the Julia ecosystem.''}
...
\cventry{2015 March -- \raisebox{0.9pt}{$\infty$}}{Honorary Life Member}{Unigames}{(UWA Student Society)}{}{}

\section{Open Source}
I am a major contributor to vastly too many projects to list here, both professionally and in my own time.
A complete list is available at \url{https://github.com/oxinabox}, and you can find various talks on some of my projects by searching YouTube for ``Frames White JuliaCon''.
Some of the more notable include: numerous contributions across the JuliaLang automatic differentiation ecosystem, including being the leader of the \emph{ChainRules.jl} project.
Other more notable packages I maintain include \emph{LoggingExtras.jl}, \emph{DataStructures.jl}, \emph{DataDeps.jl},  \emph{TestEnv.jl}, and \emph{ProjectManagement.jl}.
Previously I was also the comaintainer of \emph{TensorFlow.jl} (now deprecated).
There are functionally no large JuliaLang projects that do not include a package of mine as at least as an indirect dependency, and in most cases a direct dependency.
...
\bibNote{Note: I previously used \textbf{Lyndon~White} as a pen-name. It thus appears as such in this section. I no longer use that name.}
